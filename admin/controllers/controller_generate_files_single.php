<?php
	class _generate_files_single extends controller{
		...
		function onload(){
			...
			$this->assign("manager_for", "Generate Files Single Field & Table");
		}
		...
		function create_data(){				
			...
			if ($conn->query($sql) === TRUE) {
				...
				if($flag == 1){
					...
					$originalfile_controller_addedit = "controllers/controller_mould_single_addedit.php";
					$originalfile_controller_list = "controllers/controller_mould_single_list.php";
					$originalfile_view_addedit = "views/view_mould_single_addedit.php";
					$originalfile_view_list = "views/view_mould_single_list.php";
					$newfile_controller_addedit = str_replace("_mould_single_","_".$filename."_",$originalfile_controller_addedit);
					...
					$newfile_controller_list = str_replace("_mould_single_","_".$filename."_",$originalfile_controller_list);
					...
					$newfile_view_addedit = str_replace("_mould_single_","_".$filename."_",$originalfile_view_addedit);
					...
					$newfile_view_list = str_replace("_mould_single_","_".$filename."_",$originalfile_view_list);
