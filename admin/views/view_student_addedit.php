...
$(document).ready(function() {
	...
	var validator = $("#frm_student_addedit").validate({
...
<div class="content pt-3">
	...
	<?php $this->htmlBuilder->buildTag("form", array("action"=>"","class"=>"frm_addedit"), "frm_student_addedit");?>
        ...
        <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="actionBtns text-right">         
					...
					<div class="btn btn-o btn-sm btn-primary" onclick="window.location.href='index.php?view=student_list<?php if($this->to_do=='Edit'){ echo "&pg_no=".$this->getGetVar("page_no"); } ?>'"><i class="fa fa-times-circle mr-1" title="Close"></i><span>Close</span></div>
