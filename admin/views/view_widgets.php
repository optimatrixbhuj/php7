        ...
        <div class="row">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-warning">
                <div class="widget-user-image">
                  <img class="img-circle elevation-2" src="images/user7-128x128.jpg" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-image">
                <img class="img-circle elevation-2" src="images/user1-128x128.jpg" alt="User Avatar">
              </div>
              <div class="card-footer">
                <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-widget">
              ...
              <div class="card-footer card-comments">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="images/user4-128x128.jpg" alt="User Image">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <img class="img-fluid img-circle img-sm" src="images/user4-128x128.jpg" alt="Alt Text">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-widget">
              ...
              <div class="card-footer card-comments">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="images/user5-128x128.jpg" alt="User Image">
