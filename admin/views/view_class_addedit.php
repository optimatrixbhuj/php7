...
$(document).ready(function() {
	...
	var validator = $("#frm_class_addedit").validate({
		...
		rules: {
			...
			name: {
				...
				remote:{
					...
					url:"../scripts/ajax/check_exist.php?field_name=name&table_name=class&id=<?php echo $this->id; ?>"
...
<div class="content pt-3">
	...
	<div class="container-fluid">
		...
		<?php $this->htmlBuilder->buildTag("form", array("action"=>"","class"=>"frm_addedit"), "frm_class_addedit");?>
      ...
      <div class="row mb-2">
        <div class="col-md-6">
           ...
           <button class="btn btn-o btn-sm btn-primary"><i class="fa fa-save mr-1"></i><span id='save_txt'>Save</span></button>				
					...
					<div class="btn btn-o btn-sm btn-primary" onclick="window.location.href='index.php?view=class_list<?php if($this->to_do=='Edit'){ echo "&pg_no=".$this->getGetVar("page_no"); } ?>'"><i class="fa fa-times-circle mr-1"></i><span>Close</span></div>			
