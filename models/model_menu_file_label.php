<?php
	class model_menu_file_label{
		...
		function __CONSTRUCT($ID=0){
			...
			$this->fields["parameters"]="varchar(255)";
			$this->nullable["parameters"]="NO";
			$this->default_value["parameters"]="";
			$this->fields["file_label"]="varchar(255)";
			$this->nullable["file_label"]="NO";
			$this->default_value["file_label"]="";
